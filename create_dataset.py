...
# salinas
# img = sio.loadmat('dataset/Salinas/Salinas_corrected.mat')
# img = img['salinas_corrected']
# gt = sio.loadmat('dataset/Salinas/Salinas_gt.mat')
# gt = gt['salinas_gt']

# botswana
# img = sio.loadmat('dataset/Botswana/Botswana.mat')
# img = img['Botswana']
# gt = sio.loadmat('dataset/Botswana/Botswana_gt.mat')
# gt = gt['Botswana_gt']

# Houston 2013
data = sio.loadmat('dataset/Houston2013/Houston.mat')
img = data['Houston']
gt = sio.loadmat('dataset/Houston2013/Houston_gt.mat')
gt = gt['Houston_gt']
...
for i in range(PATCH_SIZE, mm - PATCH_SIZE):
    for j in range(PATCH_SIZE, nn - PATCH_SIZE):
        if gt[i, j] == 0:
            ...
            temp_data1 = temp_data1.reshape(PATCH_SIZE * 2, PATCH_SIZE * 2, 3)
            temp_data2 = temp_data2.reshape(PATCH_SIZE * 2, PATCH_SIZE * 2, 3)
            temp_data3 = temp_data3.reshape(PATCH_SIZE * 2, PATCH_SIZE * 2, b)
